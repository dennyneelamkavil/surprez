...
const steps = [
  {
    ...
    description: 'Set up your seller account with basic information about your craft',
  },
  {
    number: '02',
    icon: Package,
    title: 'List Your Products',
    description: 'Upload stunning photos and details about your handmade gift items',
  },
  {
    number: '03',
    icon: CheckCircle,
    title: 'Get Approved',
    description: 'Our team reviews your products to ensure quality standards are met',
  },
  {
    number: '04',
    icon: Zap,
    title: 'Start Selling',
    description: 'Go live and begin receiving orders from gift-buyers worldwide',
  },
]
    ...
    <section className="w-full bg-background py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex justify-center">
          <Button className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold px-8 py-6 rounded-full text-base">
            Start Selling Now →
          </Button>
        </div>
      </div>
