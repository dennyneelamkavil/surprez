        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <h2 className="text-5xl md:text-6xl font-bold text-primary">SURPREZ</h2>
            </div>

            <p className="text-foreground/70 text-base md:text-lg leading-relaxed max-w-md">
              Join thousands of creators reaching gift-sellers worldwide with ease and security. Turn
              your passion into a thriving business, grow at your own pace, and share your creativity
              with people who truly value meaningful gifts.
            </p>

            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-3 pt-4">
              <Button className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold px-8 py-6 text-base rounded-full">
                Start Selling Now →
              </Button>
              <Button
                variant="outline"
            ...
            <div className="flex flex-col sm:flex-row gap-6 pt-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-foreground/80">Free onboarding</span>
              </div>
              <div className="flex items-center gap-2">
                <Lock className="w-5 h-5 text-primary flex-shrink-0" />
                <span className="text-sm text-foreground/80">Secure payouts</span>
              </div>
              <div className="flex items-center gap-2">
                <Headphones className="w-5 h-5 text-primary flex-shrink-0" />
                <span className="text-sm text-foreground/80">24/7 Seller Support</span>
              </div>
            </div>
          </div>
