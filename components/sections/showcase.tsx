    ...
    <section className="w-full bg-background py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12 md:mb-16">
          <p className="text-sm font-semibold text-primary tracking-wide mb-2">SHOWCASE</p>
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            What can you sell on Surprez?
          </h2>
          <p className="text-foreground/60 max-w-2xl mx-auto">
            Sell products that bring joy, emotion, and meaning to each celebration
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {products.map((product) => (
            ...
            >
              ...
              >
                <div>
                  <p className="text-sm md:text-base font-semibold text-foreground">{product.title}</p>
                </div>
              </div>
            </div>
          ))}
