  ...
  return (
    <section className="w-full py-16 md:py-24 bg-white">
      <div className="max-w-[1200px] mx-auto px-6 text-center">
        {/* Header */}
        <h2 className="text-[24px] font-bold text-[#59489C] mb-16">
          How Surprez Works
        </h2>
        ...
        <div className="relative flex flex-col md:flex-row justify-between items-start md:items-center gap-12 md:gap-0">
          ...
          <div className="hidden md:block absolute top-[60px] left-0 w-full h-[2px] bg-[#74BE4A] -z-0" />
          ...
          {steps.map((step) => {
            ...
            return (
              ...
              >
                {/* Icon Circle */}
                <div className="w-[120px] h-[120px] bg-[#EBE6F5] rounded-full flex items-center justify-center mb-6 shadow-sm">
                  <Icon
                    className="w-12 h-12 text-[#59489C]"
                    strokeWidth={1.5}
                  />
                </div>
                ...
                <p className="text-[14px] text-gray-500 font-medium max-w-[250px] leading-relaxed">
                  {step.description}
                </p>
              </div>
            );
